...
///
///  MIDTERM ASSIGNMENT CHANTES
///
///  For the midterm assignment, the Canvas has several additional data
///  members and two additional member functions.  These facilitate the
///  implementation of the drawOutline() method.
///
...
public:
    ...
    ///
    /// Midterm assignment additions to Canvas
    ///
