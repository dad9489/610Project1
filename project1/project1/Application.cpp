...
/// PRIVATE GLOBALS
///
// These are used within this module, but not needed elsewhere.
///
...
// Drawing control
//
// Modify these as needed for the assignment.
///
...
// PUBLIC GLOBALS
//
// Things which the rest of the program needs to use.
///
...
const char *w_title = (char *) "2D Pipeline";
...
///
/// For this assignment, we accept a single command-line argument
/// which is the image (1, 2, 3, or 4) to be displayed first.  It
/// defaults to 1.
///
